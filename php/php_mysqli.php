...
$mysqli = @new mysqli('127.0.0.1', 'karinamontes', 'karina8727', 'codeup_mysqli_test_db');
...
$parks = [
    ...
    ['name' => 'Capitol Reef', 
    'location' => 'Utah', 
    'description'=> "The park\'s Waterpocket Fold is a 100-mile monocline that shows the Earth\'s geologic layers. Other natural features are monoliths and sandstone domes and cliffs shaped like the United States Capitol.",
